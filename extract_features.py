...
class ManifestProcessor:
    def __init__(self, home_directory, tool_directory, manifests_directory, extracted_csv, extraction_dir):
        self.home_directory = home_directory
        self.tool_directory = tool_directory
        self.manifests_directory = manifests_directory
        self.users_choice = extraction_dir
        self.extraction_dir = os.path.join(home_directory, tool_directory, extraction_dir)
        self.root_dir = os.path.join(home_directory, tool_directory, manifests_directory)
        self.extracted_csv = os.path.join(home_directory, tool_directory, extracted_csv)

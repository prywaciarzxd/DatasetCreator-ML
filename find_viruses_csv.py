...
if __name__ == "__main__":
    ...
    # Pobieranie ścieżki do katalogu domowego aktualnie zalogowanego użytkownika
    default_input_csv = os.path.join(os.path.expanduser('~'), 'Desktop', 'dataset_create_tool', 'text_csv_files', 'latest.csv')
    default_output_txt = os.path.join(os.path.expanduser('~'), 'Desktop', 'dataset_create_tool', 'text_csv_files', 'viruses.txt')
